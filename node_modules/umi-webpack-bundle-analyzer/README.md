...
# Yarn
yarn add -D umi-webpack-bundle-analyzer
```
...
|**`generateReportFile`**|`{Boolean}`|Default: `false`. If `true`, bundle size report JSON file will be generated in bundle output directory|
|**`reportDepth`**|`{Number}`|Default: `1`. If generateReportFile is `true`, will treeshaking bundle size report at node_modules' depth |
...
If you're on Windows and using PowerShell, you can generate the stats file with this command to [avoid BOM issues](https://github.com/webpack-contrib/umi-webpack-bundle-analyzer/issues/47):
...
```bash
umi-webpack-bundle-analyzer <bundleStatsFile> [bundleDir] [options]
```
...
umi-webpack-bundle-analyzer reports three values for sizes. `defaultSizes` can be used to control which of these is shown by default. The different reported sizes are:
...
It happens when `umi-webpack-bundle-analyzer` analyzes files that don't actually exist in your file system, for example when you work with `webpack-dev-server` that keeps all the files in RAM. If you use `umi-webpack-bundle-analyzer` as a plugin you won't get any errors, however if you run it via CLI you get the error message in terminal:
```
...
[node]: https://img.shields.io/node/v/umi-webpack-bundle-analyzer.svg
[node-url]: https://nodejs.org

[deps]: https://david-dm.org/umijs/umi-webpack-bundle-analyzer.svg
[deps-url]: https://david-dm.org/umijs/umi-webpack-bundle-analyzer

[tests]: http://img.shields.io/travis/umijs/umi-webpack-bundle-analyzer.svg
[tests-url]: https://travis-ci.org/umijs/umi-webpack-bundle-analyzer

[downloads]: https://img.shields.io/npm/dt/umi-webpack-bundle-analyzer.svg
[downloads-url]: https://npmjs.com/package/umi-webpack-bundle-analyzer
