...
class BundleAnalyzerPlugin {
  ...
  async generateReportFile(stats) {
    ...
    try {
      ...
      this.logger.info(`${bold('Umi Webpack Bundle Analyzer')} saved report file to ${bold(statsFilepath)}`);
    } catch (error) {
      this.logger.error(`${bold('Umi Webpack Bundle Analyzer')} error saving report data to ${bold(statsFilepath)} : ${error}`);
    }
  }
  ...
  async generateStatsFile(stats) {
    ...
    try {
      ...
      this.logger.info(`${bold('Umi Webpack Bundle Analyzer')} saved stats file to ${bold(statsFilepath)}`);
    } catch (error) {
      this.logger.error(`${bold('Umi Webpack Bundle Analyzer')} error saving stats file to ${bold(statsFilepath)}: ${error}`);
    }
  }
